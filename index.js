document.addEventListener('DOMContentLoaded', function () {
    ...
    function moveFrog(e) {
        ...
        switch (e.keyCode) {
            case 37:
                if (currentIndex % width !== 0) currentIndex -= 1; // move left 1 space
                break;
            case 38:
                if (currentIndex - width >= 0) currentIndex -= width; // arrow up
                break;
            case 39:
                if (currentIndex % width < width - 1) currentIndex += 1 // move right 1 space
            case 40:
